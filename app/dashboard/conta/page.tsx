    ...
    <>
      ...
      <div className="p-6">
        <div className="max-w-4xl">
          {/* Tabs */}
          <div className="flex gap-1 mb-6 border-b border-vogel-green-dark/20">
            {[
              ...
              <button
                ...
                className={`px-4 py-3 font-medium text-sm transition-colors relative ${
                  activeTab === tab.id
                    ? "text-vogel-gold"
                    : "text-vogel-gray hover:text-vogel-white"
                }`}
              >
                {tab.label}
                {activeTab === tab.id && (
          ...
          {activeTab === "perfil" && (
            <div className="space-y-6">
              <div className="bg-vogel-black/50 border border-vogel-green-dark/30 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-vogel-white mb-6">
                  Informações Pessoais
                </h3>

                <div className="space-y-4">
                  <div>
                    <label className="block text-vogel-gray text-sm mb-2">
                      Nome completo
                    </label>
                    <div className="flex items-center gap-3">
                      <User className="w-5 h-5 text-vogel-gray" />
                      <input
                        type="text"
                        defaultValue={usuario.nome}
                        className="flex-1 bg-vogel-black border border-vogel-green-dark/30 rounded-lg px-4 py-3 text-vogel-white focus:border-vogel-gold outline-none"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <Mail className="w-5 h-5 text-vogel-gray" />
                      <input
                        type="email"
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <Phone className="w-5 h-5 text-vogel-gray" />
                      <input
                        type="tel"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-vogel-black/50 border border-vogel-green-dark/30 rounded-xl p-6">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <h3 className="text-lg font-semibold text-vogel-white mb-1">
                      Plano {usuario.plano}
                    </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-vogel-green-dark/10 rounded-lg">
                    <div className="flex items-center gap-2 text-vogel-gray text-sm mb-1">
                      <CreditCard className="w-4 h-4" />
                      Valor
                    </div>
                    <p className="text-vogel-white font-semibold">
                      {usuario.valorMensal}
                    </p>
                  </div>
              ...
              <div className="bg-vogel-black/50 border border-vogel-green-dark/30 rounded-xl overflow-hidden">
                <button className="w-full flex items-center justify-between p-4 hover:bg-vogel-green-dark/10 transition-colors border-b border-vogel-green-dark/20">
                  <div className="flex items-center gap-3">
                    <CreditCard className="w-5 h-5 text-vogel-gray" />
                    <span className="text-vogel-white">
                      Alterar forma de pagamento
                    </span>
                  </div>
                  <ChevronRight className="w-5 h-5 text-vogel-gray" />
                </button>

                <button className="w-full flex items-center justify-between p-4 hover:bg-vogel-green-dark/10 transition-colors border-b border-vogel-green-dark/20">
                  <div className="flex items-center gap-3">
                    <Calendar className="w-5 h-5 text-vogel-gray" />
                    <span className="text-vogel-white">
            ...
            <div className="bg-vogel-black/50 border border-vogel-green-dark/30 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center justify-between p-4 bg-vogel-green-dark/10 rounded-lg"
                  >
                    <div>
                      <p className="text-vogel-white font-medium">{item.title}</p>
                      <p className="text-vogel-gray text-sm">{item.desc}</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div className="w-11 h-6 bg-vogel-green-dark/50 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-vogel-gold"></div>
                    </label>
                  </div>
                ))}
              </div>
          ...
          {activeTab === "seguranca" && (
            <div className="space-y-6">
              <div className="bg-vogel-black/50 border border-vogel-green-dark/30 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      type="password"
                      className="w-full bg-vogel-black border border-vogel-green-dark/30 rounded-lg px-4 py-3 text-vogel-white focus:border-vogel-gold outline-none"
                      placeholder="••••••••"
                    />
                  </div>
              ...
              <div className="bg-vogel-black/50 border border-vogel-green-dark/30 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-vogel-white mb-2">
                  Excluir Conta
                </h3>
